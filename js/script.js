...

{
  ...
  const totalSum = (cartTotal) => {
    ...
    const newSum = cartTotal.reduce(
        (initialValue, currentItem) => +currentItem.subTotal + initialValue, 0);
  ...
  const formSubmit = (form, closeForm) => {
    ...
    form.addEventListener('change', (e) => {
      ...
      if (form.discount.checked) {
        ...
        totalPrice = (+form.price.value - +form.price.value * (form.discount_count.value / 100)) * +form.count.value;
      } else {
    ...
    form.addEventListener('submit', (e) => {
      ...
      newItem.subTotal = !newItem.discount ? subtotal : subtotal - subtotal * (newItem.discount_count / 100);
